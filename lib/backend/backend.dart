...
import 'schema/productssold_record.dart';
...
export 'schema/productssold_record.dart';
...
/// Functions to query ProductssoldRecords (as a Stream and as a Future).
Future<int> queryProductssoldRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ProductssoldRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ProductssoldRecord>> queryProductssoldRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProductssoldRecord.collection,
      ProductssoldRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProductssoldRecord>> queryProductssoldRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
