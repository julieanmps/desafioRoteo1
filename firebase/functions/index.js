...
const kStripeTestSecretKey =
  "sk_test_51QrUglJHcTWMvvNBM2AzUtJ2wvlKrC1zrG93YtABBX5lGKtWOk201KzefBZdHuu8yd8xUh2aOhjt2DkXuTXlmZvD00rIpA3Ntj";
...
exports.ffPrivateApiCall = functions
  .region("southamerica-east1")
  .runWith({ minInstances: 0, maxInstances: 3, timeoutSeconds: 120 })
  .https.onCall(async (data, context) => {
    try {
...
exports.ffPrivateApiCallV2 = onRequest(
  { cors: true, minInstances: 0, maxInstances: 3, timeoutSeconds: 120 },
  async (req, res) => {
    try {
      const context = {
